...
You can also optionally specify which custom view file you would like to use for rendering the breadcrumbs:

```erb
<%= render_breadcrumbs view: 'path/to/custom/breadcrumbs' %>
```
